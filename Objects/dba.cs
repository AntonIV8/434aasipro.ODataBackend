...
namespace DataLine.434aasipro
{
    ...
    public class dba : ICSSoft.STORMNET.DataObject
    {
        ...
        private DataLine.434aasipro.dba fprev_version;
        ...
        [PropertyStorage(new string[] {
                "prev_version"})]
        public virtual DataLine.434aasipro.dba prev_version
        {
            get
            {
                ...
                DataLine.434aasipro.dba result = this.fprev_version;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View dbaE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("dbaE", typeof(DataLine.434aasipro.dba));
                }
            }
            ...
            public static ICSSoft.STORMNET.View dbaL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("dbaL", typeof(DataLine.434aasipro.dba));
                }
            }
        }
    }
