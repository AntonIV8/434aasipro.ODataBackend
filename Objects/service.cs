...
namespace DataLine.434aasipro
{
    ...
    public class service : ICSSoft.STORMNET.DataObject
    {
        ...
        [PropertyStorage(new string[] {
                "parent_id"})]
        public virtual DataLine.434aasipro.service parent_id
        {
            get
            {
                ...
                DataLine.434aasipro.service result = this.fparent_id;
        ...
        [NotNull()]
        public virtual DataLine.434aasipro.service_state state
        {
            get
            {
                ...
                DataLine.434aasipro.service_state result = this.fstate;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View serviceE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("serviceE", typeof(DataLine.434aasipro.service));
                }
            }
            ...
            public static ICSSoft.STORMNET.View serviceL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("serviceL", typeof(DataLine.434aasipro.service));
                }
            }
        }
    }
