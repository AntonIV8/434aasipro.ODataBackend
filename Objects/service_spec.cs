...
namespace DataLine.434aasipro
{
    ...
    public class service_spec : ICSSoft.STORMNET.DataObject
    {
        ...
        private DataLine.434aasipro.catalog fcatalog_key;
        
        private DataLine.434aasipro.service_spec fparent_id;
        ...
        [PropertyStorage(new string[] {
                "catalog_key"})]
        public virtual DataLine.434aasipro.catalog catalog_key
        {
            get
            {
                ...
                DataLine.434aasipro.catalog result = this.fcatalog_key;
        ...
        [NotNull()]
        public virtual DataLine.434aasipro.service_spec parent_id
        {
            get
            {
                ...
                DataLine.434aasipro.service_spec result = this.fparent_id;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View service_specE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("service_specE", typeof(DataLine.434aasipro.service_spec));
                }
            }
            ...
            public static ICSSoft.STORMNET.View service_specL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("service_specL", typeof(DataLine.434aasipro.service_spec));
                }
            }
        }
    }
