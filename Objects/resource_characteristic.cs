...
namespace DataLine.434aasipro
{
    ...
    public class resource_characteristic : ICSSoft.STORMNET.DataObject
    {
        ...
        private DataLine.434aasipro.resource fresource_id;
        ...
        [PropertyStorage(new string[] {
                "resource_id"})]
        [NotNull()]
        public virtual DataLine.434aasipro.resource resource_id
        {
            get
            {
                ...
                DataLine.434aasipro.resource result = this.fresource_id;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View resource_characteristicE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("resource_characteristicE", typeof(DataLine.434aasipro.resource_characteristic));
                }
            }
            ...
            public static ICSSoft.STORMNET.View resource_characteristicL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("resource_characteristicL", typeof(DataLine.434aasipro.resource_characteristic));
                }
            }
        }
    }
